...
export const translations: Record<Language, TranslationContent> = {
  ...
  pt: {
    ...
    dossier: {
      ...
      section2_intro: "Enquanto se negam fundos para os consulados sob a alegação de escassez, financiam-se operações externas milionárias. Isso prova que o bloqueio da cidadania é uma escolha política, não econômica.",
      ...
      section3_text: "A justificativa oficial da lei é 'segurança'. Mas o inquérito 'Click Day' revela a hipocrisia: enquanto bloqueiam descendentes (com sangue italiano), o governo permitiu que a máfia infiltrasse o sistema de fluxos.",
      section3_subtext: "Não é uma opinião, é uma admissão oficial do próprio governo.",
  ...
  en: {
    ...
    dossier: {
      ...
      section3_text: "The official excuse for the law is 'security'. But the 'Click Day' inquiry reveals the hypocrisy: while blocking descendants (with Italian blood), the government allowed the mafia to infiltrate the flow system.",
      section3_subtext: "This is not an opinion, it's an official government admission.",
  ...
  es: {
    ...
    dossier: {
      ...
      title_line2: "PARADIGMÁTICA",
      quote: "\"La Ley 74/2025 no regula el futuro, sino que borra el pasado. Es un acto de expropriaación jurídica masiva.\"",
      ...
      video_analysis: "CONEXIÓN: Los fondos para la 'estabilidad' tunecina derivan directamente de recortes a servicios consulares para italianos en el exterior.",
      card_albania_title: "Costo Albania: €160M",
      ...
      section3_card_title: "Dossier Click Day",
      section3_text: "La excusa oficial de la ley es la 'seguridad'. Pero la investigación 'Click Day' revela la hipocresía: mientras bloquean a descendientes (con sangre italiana), el gobierno permitió que la mafia infiltrara el sistema de flujos.",
      section3_subtext: "No es una opinión, es una admisión oficial del propio gobierno.",
