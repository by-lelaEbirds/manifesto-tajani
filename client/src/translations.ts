...
export type TranslationContent = {
  ...
  dossier: {
    ...
    section_force_majeure_fact_title: string;
    section_force_majeure_fact_desc: string;
    section_force_majeure_law_title: string;
    section_force_majeure_law_desc: string;
    ...
    // Novos campos para os Cards Judiciais
    conclusion_turin_title: string;
    conclusion_turin_desc: string;
    conclusion_lazio_title: string;
    conclusion_lazio_desc: string;
    // Fim novos campos
...
export const translations: Record<Language, TranslationContent> = {
  it: {
    ...
    dossier: {
      ...
      section_force_majeure_title: "Tesi della Forza Maggiore e Denegata Giustizia",
      section_force_majeure_text: "Secondo il principio 'ad impossibilia nemo tenetur', il cittadino non può perdere un diritto a causa dell'inefficienza tecnica della Pubblica Amministrazione. Il collasso del portale 'Prenot@mi' non è un semplice disservizio, ma un ostacolo insormontabile creato dallo Stato.",
      section_force_majeure_fact_title: "Il Fatto Amministrativo",
      section_force_majeure_fact_desc: "File virtuali di oltre 10 anni e bug sistemici hanno impedito la prenotazione tempestiva a migliaia di richiedenti, configurando una 'impossibilità oggettiva'.",
      section_force_majeure_law_title: "La Conseguenza Giuridica",
      section_force_majeure_law_desc: "Lo Stato non può sanzionare il cittadino per la propria inadempienza. La scadenza del 27 marzo è inopponibile a chi ha tentato invano di prenotare.",
      section4_title: "L'Arma 'Ius Italiae'",
      section4_text1: "La proposta 'Ius Italiae' non è una riforma, ma un atto di revisionismo storico che rinnega le radici risorgimentali dell'Italia.",
      section4_text2: "L'obiettivo politico è sostituire il diritto di sangue (ius sanguinis, storico e permanente) con una naturalizzazione precaria e revocabile.",
      section4_point_a_title: "Limite 2ª Generazione",
      section4_point_a_desc: "Esclusione arbitraria basata sulla data di nascita dell'avo. Si crea una cittadinanza a tempo determinato, cancellando il legame di sangue oltre i nipoti.",
      section4_point_b_title: "Abolizione Regola 1861",
      section4_point_b_desc: "Negazione della continuità storica dello Stato. Se si disconosce la cittadinanza ai discendenti dei fondatori del Regno d'Italia, si nega la legittimità dello Stato stesso.",
      section5_title: "Ingegneria Demografica: 'Ius Scholae'",
      section5_text1: "La strategia è chiara: chiudere la porta a chi ha sangue italiano (passato) per spalancarla allo Ius Scholae (futuro incerto). Questa non è integrazione, è sostituzione etnica programmata.",
      section5_text2: "Con proiezioni ISMU che indicano 1 milione di studenti stranieri, lo Ius Scholae diventa uno strumento di alterazione demografica irreversibile, preferendo l'importazione di manodopera alla valorizzazione della diaspora.",
      conclusion_title: "Perspectivas Judiciais",
      conclusion_text: "La battaglia si è spostata dai consolati alle aule di giustizia. Due fronti legali hanno già aperto brecce decisive nel muro eretto dal governo.",
      conclusion_turin_title: "Fronte Costituzionale",
      conclusion_turin_desc: "Tribunale di Torino (Ord. 25/06/2025). Il giudice ha sollevato la questione di legittimità costituzionale per violazione dei 'diritti quesiti'. È l'ariete legale contro la retroattività.",
      conclusion_lazio_title: "Fronte Amministrativo",
      conclusion_lazio_desc: "TAR del Lazio (Udienza Nov 2025). Ricorso collettivo contro la Circolare 26185. Si contesta l'eccesso di potere del Ministero nell'imporre scadenze ai minori non previste dalla legge.",
  ...
  pt: {
    ...
    dossier: {
      ...
      card_tax_text: "O D.L. 36/2025 impone uma taxa de €600 por processo, transformando um direito fundamental em um produto de luxo. É a monetização da cidadania e uma barreira de classe inconstitucional.",
      ...
      section_force_majeure_title: "Tese de Força Maior e Denegação de Justiça",
      section_force_majeure_text: "Segundo o princípio 'ad impossibilia nemo tenetur', o cidadão não pode perder um direito devido à ineficiência técnica da Administração Pública. O colapso do portal 'Prenot@mi' não é um simples erro, é um obstáculo intransponível criado pelo Estado.",
      section_force_majeure_fact_title: "O Fato Administrativo",
      section_force_majeure_fact_desc: "Filas virtuais de mais de 10 anos e bugs sistêmicos impediram o agendamento tempestivo de milhares de requerentes, configurando 'impossibilidade objetiva'.",
      section_force_majeure_law_title: "A Consequência Jurídica",
      section_force_majeure_law_desc: "O Estado não pode punir o cidadão por sua própria inadimplência. O prazo de 27 de março é inoponível a quem tentou agendar em vão.",
      section4_title: "A Arma 'Ius Italiae'",
      section4_text1: "A proposta 'Ius Italiae' não é uma reforma, é um ato de revisionismo histórico que renega as raízes risorgimentais da Itália.",
      section4_text2: "O objetivo político é substituir o direito de sangue (ius sanguinis, histórico e permanente) por uma naturalização precária e revogável.",
      section4_point_a_title: "Limite 2ª Geração",
      section4_point_a_desc: "Exclusão arbitrária baseada na data de nascimento do antepassado. Cria-se uma cidadania com prazo de validade, apagando o vínculo de sangue além dos netos.",
      section4_point_b_title: "Abolição Regra 1861",
      section4_point_b_desc: "Negação da continuidade histórica do Estado. Se desconhecem a cidadania aos descendentes dos fundadores do Reino de Itália, nega-se a legitimidade do próprio Estado.",
      section5_title: "Engenharia Demográfica: 'Ius Scholae'",
      section5_text1: "A estratégia é clara: fechar a porta para quem tem sangue italiano (passado) para escancarar a do Ius Scholae (futuro incerto). Isso não é integração, é substituição étnica programada.",
      section5_text2: "Com projeções do ISMU indicando em breve 1 milhão de estudantes estrangeiros, o Ius Scholae torna-se um instrumento de alteração demográfica irreversível, preferindo a importação de mão de obra à valorização da diáspora.",
      conclusion_title: "Perspectivas Judiciais",
      conclusion_text: "A batalha legal deslocou-se dos consulados para os tribunais. Duas frentes legais já abriram brechas decisivas no muro erguido pelo governo.",
      conclusion_turin_title: "Front Constitucional",
      conclusion_turin_desc: "Tribunal de Turim (Ord. 25/06/2025). O juiz levantou a questão de legitimidade constitucional por violação de 'direitos adquiridos'. É o aríete legal contra a retroatividade.",
      conclusion_lazio_title: "Front Administrativo",
      conclusion_lazio_desc: "TAR do Lácio (Audiência Nov 2025). Recurso coletivo contra a Circular 26185. Contesta-se o excesso de poder do Ministério ao impor prazos aos menores não previstos em lei.",
  ...
  en: {
    ...
    dossier: {
      ...
      section_minors_circular: "Circular 26185 (05/28/2025): Introduce forfeiture deadlines for minors, an administrative excess of power challenged at the Lazio TAR.",
      section_force_majeure_title: "Force Majeure and Justice Denial",
      section_force_majeure_text: "According to the principle 'ad impossibilia nemo tenetur', the citizen cannot lose a right due to the technical inefficiency of the Public Administration. The 'Prenot@mi' portal collapse is not a simple glitch, but an insurmountable obstacle created by the State.",
      section_force_majeure_fact_title: "The Administrative Fact",
      section_force_majeure_fact_desc: "Virtual queues of over 10 years and systemic bugs prevented timely booking for thousands of applicants, constituting 'objective impossibility'.",
      section_force_majeure_law_title: "The Legal Consequence",
      section_force_majeure_law_desc: "The State cannot sanction the citizen for its own default. The March 27 deadline is unenforceable against those who tried to book in vain.",
      section4_title: "The 'Ius Italiae' Weapon",
      section4_text1: "The proposal 'Ius Italiae' is not a reform, but a rewriting of national history that denies the roots of Italian Unity.",
      section4_text2: "The political goal is to replace blood right (historical and permanent) with precarious and revocable naturalization.",
      section4_point_a_title: "2nd Generation Limit",
      section4_point_a_desc: "Arbitrary exclusion based on ancestor's birth date. It creates a citizenship with an expiration date, erasing the blood link beyond grandchildren.",
      section4_point_b_title: "Abolition of 1861 Rule",
      section4_point_b_desc: "Denial of the historical continuity of the State. If citizenship is denied to the descendants of the Kingdom of Italy's founders, the legitimacy of the State itself is denied.",
      section5_title: "Demographic Engineering: 'Ius Scholae'",
      section5_text1: "The strategy is clear: close the door to those with Italian blood (past) to throw open the one to Ius Scholae (uncertain future). This is not integration, it is programmed ethnic substitution.",
      section5_text2: "With ISMU projections indicating 1 million foreign students soon, Ius Scholae becomes an irreversible tool of demographic alteration, preferring labor importation over diaspora valuation.",
      conclusion_title: "Judicial Perspectives",
      conclusion_text: "The legal battle has shifted from consulates to courtrooms. Two legal fronts have already opened decisive breaches in the government's wall.",
      conclusion_turin_title: "Constitutional Front",
      conclusion_turin_desc: "Turin Tribunal (Ord. 06/25/2025). The judge raised the question of constitutional legitimacy for violation of 'acquired rights'. It is the legal battering ram against retroactivity.",
      conclusion_lazio_title: "Administrative Front",
      conclusion_lazio_desc: "Lazio TAR (Hearing Nov 2025). Collective appeal against Circular 26185. It contests the Ministry's excess of power in imposing deadlines on minors not foreseen by law.",
  ...
  es: {
    ...
    dossier: {
      ...
      section_force_majeure_title: "Tesis de Fuerza Mayor y Denegación de Justicia",
      section_force_majeure_text: "Según el principio 'ad impossibilia nemo tenetur', el ciudadano no puede perder un derecho debido a la ineficiencia técnica de la Administración Pública. El colapso del portal 'Prenot@mi' no es un simple fallo, es un obstáculo insuperable creado por el Estado.",
      section_force_majeure_fact_title: "El Hecho Administrativo",
      section_force_majeure_fact_desc: "Filas virtuales de más de 10 años y errores sistémicos impidieron la reserva oportuna a miles de solicitantes, configurando 'imposibilidad objetiva'.",
      section_force_majeure_law_title: "La Consecuencia Jurídica",
      section_force_majeure_law_desc: "El Estado no puede sancionar al ciudadano por su propio incumplimiento. El plazo del 27 de marzo es inoponible a quien intentó reservar en vano.",
      section4_title: "El Arma 'Ius Italiae'",
      section4_text1: "La propuesta 'Ius Italiae' no es una reforma, es un acto de revisionismo histórico que reniega de las raíces risorgimentales de Italia.",
      section4_text2: "El objetivo político es sustituir el derecho de sangre (ius sanguinis, histórico y permanente) por una naturalización precaria y revocable.",
      section4_point_a_title: "Límite 2ª Generación",
      section4_point_a_desc: "Exclusión arbitraria basada en la fecha de nacimiento del antepasado. Se crea una ciudadanía con fecha de caducidad, borrando el vínculo de sangre más allá de los nietos.",
      section4_point_b_title: "Abolición Regra 1861",
      section4_point_b_desc: "Negación de la continuidad histórica del Estado. Si se desconoce la ciudadanía a los descendientes de los fundadores del Reino de Italia, se niega la legitimidad del propio Estado.",
      section5_title: "Ingeniería Demográfica: 'Ius Scholae'",
      section5_text1: "La estrategia es clara: cerrar la puerta a quien tiene sangre italiana (pasado) para abrir de par en par la del Ius Scholae (futuro incierto). Esto no es integración, es sustitución étnica programada.",
      section5_text2: "Con proyecciones del ISMU indicando pronto 1 millón de estudiantes extranjeros, el Ius Scholae se convierte en una herramienta de alteración demográfica irreversible, prefiriendo la importación de mano de obra a la valoración de la diáspora.",
      conclusion_title: "Perspectivas Judiciales",
      conclusion_text: "La batalla legal se ha desplazado de los consulados a los tribunales. Dos frentes legales ya han abierto brechas decisivas en el muro erigido por el gobierno.",
      conclusion_turin_title: "Frente Constitucional",
      conclusion_turin_desc: "Tribunal de Turín (Ord. 25/06/2025). El juez planteó la cuestión de legitimidad constitucional por violación de 'derechos adquiridos'. Es el ariete legal contra la retroactividad.",
      conclusion_lazio_title: "Frente Administrativo",
      conclusion_lazio_desc: "TAR del Lacio (Audiencia Nov 2025). Recurso colectivo contra la Circular 26185. Se impugna el exceso de poder del Ministerio al imponer plazos a los menores no previstos por la ley.",
      disclaimer_title: "Nota Legal",
