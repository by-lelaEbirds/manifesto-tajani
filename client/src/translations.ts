...
export const translations: Record<Language, TranslationContent> = {
  it: {
    ...
    dossier: {
      ...
      section3_text: "La scusa ufficiale per la legge è la 'sicurezza'. Ma l'inchiesta 'Click Day' rivela l'ipocrisia: mentre si bloccano i discendenti (che hanno sangue italiano), il governo ha permesso alla mafia di infiltrare il sistema flussi.",
      section3_subtext: "Non è un'opinione, è un'ammissione ufficiale del governo.",
      ...
      section_force_majeure_title: "Tese di Forza Maggiore e Denegata Giustizia",
      ...
      section4_text1: "La proposta non è una riforma, ma una riscrittura della storia nazionale che nega le radici dell'Unità d'Italia.",
      section4_text2: "L'obiettivo è sostituire il diritto di sangue (storico e permanente) con una naturalizzazione precaria e revocabile.",
      section4_point_a_title: "Limite 2ª Generazione",
      section4_point_a_desc: "Esclusione arbitraria basata sulla data di nascita dell'avo. Si crea una cittadinanza a scadenza, cancellando il legame di sangue oltre i nipoti.",
      section4_point_b_title: "Abolizione Regola 1861",
      section4_point_b_desc: "Negazione della continuità storica dello Stato. Se si disconosce la cittadinanza ai discendenti dei fondatori del Regno d'Italia, si disconosce l'Italia stessa.",
      section5_title: "Ingegneria Demografica: 'Ius Scholae'",
      section5_text1: "Mentre si chiude la porta ai discendenti di sangue italiano, si spalanca quella dello Ius Scholae. Questa non è integrazione, è sostituzione.",
      section5_text2: "Con proiezioni ISMU che indicano presto 1 milione di studenti stranieri, lo Ius Scholae diventa uno strumento di alterazione demografica irreversibile, preferendo l'importazione di manodopera alla valorizzazione della diaspora.",
  ...
  pt: {
    ...
    demands: {
      ...
      item1_desc: "Impugnazione da Circular 26185 por 'excesso de poder' sobre os menores.",
    ...
    dossier: {
      ...
      section_force_majeure_title: "Tese de Força Maior e Negação de Justiça",
      ...
      section4_text1: "A proposta não é uma reforma, é uma reescrita da história nacional que nega as raízes da Unidade da Itália.",
      section4_text2: "O objetivo é substituir o direito de sangue (histórico e permanente) por uma naturalização precária e revogável.",
      ...
      section4_point_b_desc: "Negação da continuidade histórica do Estado. Se desconhecem a cidadania aos descendentes dos fundadores do Reino de Itália, desconhecem a própria Itália.",
      section5_title: "Engenharia Demográfica: 'Ius Scholae'",
      section5_text1: "Enquanto se fecha a porta aos descendentes de sangue italiano, escancara-se a do Ius Scholae. Isso não é integração, é substituição.",
  ...
  en: {
    ...
    dossier: {
      ...
      section4_text1: "The proposal is not a reform, but a rewriting of national history that denies the roots of Italian Unity.",
      section4_text2: "The goal is to replace blood right (historical and permanent) with precarious and revocable naturalization.",
      section4_point_a_title: "2nd Generation Limit",
      section4_point_a_desc: "Arbitrary exclusion based on the ancestor's birth date. It creates a citizenship with an expiration date, erasing the blood link beyond grandchildren.",
      section4_point_b_title: "Abolition of 1861 Rule",
      section4_point_b_desc: "Denial of the historical continuity of the State. If citizenship is denied to the descendants of the Kingdom of Italy's founders, Italy itself is denied.",
      section5_title: "Demographic Engineering: 'Ius Scholae'",
      section5_text1: "While closing the door to Italian blood descendants, the one to Ius Scholae is thrown open. This is not integration, it is substitution.",
  ...
  es: {
    ...
    dossier: {
      ...
      section4_text1: "La propuesta no es una reforma, es una reescritura de la historia nacional que niega las raíces de la Unidad de Italia.",
      section4_text2: "El objetivo es sustituir el derecho de sangre (histórico y permanente) por una naturalización precaria y revocable.",
      ...
      section4_point_b_desc: "Negación de la continuidad histórica del Estado. Si se desconoce la ciudadanía a los descendientes de los fundadores del Reino de Italia, se desconoce a la propia Italia.",
      section5_title: "Ingeniería Demográfica: 'Ius Scholae'",
      section5_text1: "Mientras se cierra la puerta a los descendientes de sangre italiana, se abre de par en par la del Ius Scholae. Esto no es integración, es sustitución.",
